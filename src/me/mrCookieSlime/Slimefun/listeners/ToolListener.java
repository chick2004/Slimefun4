...
public class ToolListener implements Listener {
	...
	public void onBlockPlace(BlockPlaceEvent e) {
		...
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.TIN_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.COPPER_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.SILVER_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.LEAD_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.ALUMINUM_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.ZINC_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.MAGNESIUM_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.IRON_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_4K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_6K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_8K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_10K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_12K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_14K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_16K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_18K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_20K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_22K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_24K_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.IRON_ORE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GOLD_ORE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.DIAMOND_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.DIAMOND_ORE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.EMERALD_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.EMERALD_ORE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.LAPIS_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.LAPIS_ORE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.REDSTONE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.REDSTONE_ORE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.REDSTONE_ALLOY_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.MAGNET_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.CARBON_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.STEEL_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.DAMASCUS_STEEL_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.BRONZE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.DURALUMIN_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.BILLON_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.BRASS_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.ALUMINUM_BRASS_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.ALUMINUM_BRONZE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.CORINTHIAN_BRONZE_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.SOLDER_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.HARDENED_METAL_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.REINFORCED_ALLOY_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.NICKEL_LIQUID, true)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.COBALT_LIQUID, true)) e.setCancelled(true);
		...
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.DOUBLE_BACKPACK, false)) e.setCancelled(true);
		...
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.TIN_LIQUID, false)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.LEAD_LIQUID, false)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.ZINC_LIQUID, false)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.ALUMINUM_LIQUID, false)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.MAGNESIUM_LIQUID, false)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.SILVER_LIQUID, false)) e.setCancelled(true);
		else if (SlimefunManager.isItemSimiliar(item, SlimefunItems.IRON_LIQUID, false)) e.setCancelled(true);
