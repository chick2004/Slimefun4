...
public class ResearchSetup {
	...
	public static void setupResearches() {
	    ...
	    Slimefun.registerResearch(new Research(32, "Nether Gold Pan", 9), new ItemStack[] {SlimefunItems.NETHER_GOLD_PAN});
	    ...
	    Slimefun.registerResearch(new Research(240, "Output Chest", 35), SlimefunItems.OUTPUT_CHEST);
	    Slimefun.registerResearch(new Research(241, "Melter & Solidifier", 20), SlimefunItems.MELTER, SlimefunItems.SOLIDIFIER);
	    Slimefun.registerResearch(new Research(242, "Spray Solidifier", 23), SlimefunItems.SPRAY_SOLIDIFIER);
	    Slimefun.registerResearch(new Research(243, "Crystallizer", 10), SlimefunItems.CRYSTALLIZER);
	    Slimefun.registerResearch(new Research(244, "Centrifuge", 30), SlimefunItems.CENTRIFUGE);
	    Slimefun.registerResearch(new Research(245, "Mixer", 20), SlimefunItems.MIXER);
	    Slimefun.registerResearch(new Research(246, "Hammer", 12), SlimefunItems.HAMMER);
