...
public class WitherAssembler extends SlimefunItem {
			...
			public void newInstance(final BlockMenu menu, final Block b) {
				try {
					if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getBlockInfo(b, "enabled") == null || BlockStorage.getBlockInfo(b, "enabled").equals("false")) {
						menu.replaceExistingItem(22, new CustomItem(new MaterialData(Material.SULPHUR), "&7Mở: &4\u2718", "", "&e> Ấn để mở máy"));
						...
						menu.replaceExistingItem(22, new CustomItem(new MaterialData(Material.REDSTONE), "&7Mở: &2\u2714", "", "&e> Ấn để tắt máy"));
						menu.addMenuClickHandler(22, new MenuClickHandler() {
					...
					menu.replaceExistingItem(31, new CustomItem(new MaterialData(Material.PISTON_BASE), "&7Vị trí triệu hồi: &3" + offset + " Block", "", "&rChuột trái: &7+0.1", "&rChuột phải: &7-0.1"));
	...
	private void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(1, new CustomItem(new MaterialData(Material.SKULL_ITEM, (byte) 1), "&7Khoang đặt đầu Wither"),
		new MenuClickHandler() {
		...
		preset.addItem(7, new CustomItem(new MaterialData(Material.SOUL_SAND), "&7Khoang đặt cát linh hồn"),
		new MenuClickHandler() {
		...
		preset.addItem(13, new CustomItem(new MaterialData(Material.WATCH), "&7Thời gian hồi: &b30 giây"),
		new MenuClickHandler() {
	...
	public String getInventoryTitle() {
		return "&5Máy triệu hồi Wither Boss";
	}
