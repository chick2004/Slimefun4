...
public abstract class AutomatedCraftingChamber extends SlimefunItem {
	...
	public AutomatedCraftingChamber(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack[] recipe) {
		...
		new BlockMenuPreset(name, "&6Máy chế tạo tự động") {
			...
			public void newInstance(final BlockMenu menu, final Block b) {
				if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getBlockInfo(b, "enabled") == null || BlockStorage.getBlockInfo(b, "enabled").equals("false")) {
					menu.replaceExistingItem(6, new CustomItem(new MaterialData(Material.SULPHUR), "&7Mở: &4\u2718", "", "&e> Ấn để kích hoạt máy"));
					...
					menu.replaceExistingItem(6, new CustomItem(new MaterialData(Material.REDSTONE), "&7Mở: &2\u2714", "", "&e> Ấn để tắt máy"));
					menu.addMenuClickHandler(6, new MenuClickHandler() {
	...
	protected void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(2, new CustomItem(new MaterialData(Material.WORKBENCH), "&eCông thức", "", "&bĐặt công thức của &6Bàn chế tạo cao cấp"),
		new MenuClickHandler() {
