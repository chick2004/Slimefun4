...
public abstract class AReactor extends SlimefunItem {
			...
			public void newInstance(final BlockMenu menu, final Block b) {
				try {
					...
					if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getBlockInfo(b, "reactor-mode").equals("generator")) {
						menu.replaceExistingItem(4, new CustomItem(CustomSkull.getItem("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTM0M2NlNThkYTU0Yzc5OTI0YTJjOTMzMWNmYzQxN2ZlOGNjYmJlYTliZTQ1YTdhYzg1ODYwYTZjNzMwIn19fQ=="), "&7Chế độ: &eĐiện", "", "&6Tạo điện cho đến khi Mạng điện không cần điện", "", "&7> Ấn để đổi chế độ sang &eSản xuất"));
						...
						menu.replaceExistingItem(4, new CustomItem(SlimefunItems.PLUTONIUM, "&7Chế độ: &eSản xuất", "", "&6Sản xuất một số vật phẩm", "", "&7> Ấn để đổi chế độ sang &eĐiện"));
						menu.addMenuClickHandler(4, new MenuClickHandler() {
	...
	private void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(1, new CustomItem(SlimefunItems.URANIUM, "&7Khoang nhiên liệu", "", "&rSử dụng &2Uranium &rhoặc &aNeptunium"),
		new MenuClickHandler() {
		...
		if (needsCooling()) {
			preset.addItem(7, new CustomItem(this.getCoolant(), "&bKhoang làm mát", "", "&rSử dụng &bBăng tản nhiệt", "&4Nếu không , lò sẽ nổ"));
		}
		else {
            preset.addItem(7, new CustomItem(new MaterialData(Material.BARRIER), "&bKhoang làm mát", "", "&rChỉ nhận &bBăng tản nhiệt"));

            for (int i : border_4) {
                preset.addItem(i, new CustomItem(new ItemStack(Material.BARRIER), "&cKhông cần &bBăng tản nhiệt"),
                new MenuClickHandler() {
