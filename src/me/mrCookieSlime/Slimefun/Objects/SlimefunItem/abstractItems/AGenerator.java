...
public abstract class AGenerator extends SlimefunItem {
	...
	private static final int[] border = {8, 26};
	private static final int[] border_in = {0,1, 2, 3, 4, 5, 6, 7, 9, 16, 18, 19, 20, 21, 22, 23, 24, 25};
	...
	private void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(17, new CustomItem(new MaterialData(Material.STAINED_GLASS_PANE, (byte) 15), " "),
		new MenuClickHandler() {
			...
			public double generateEnergy(Location l, SlimefunItem sf, Config data) {
				if (isProcessing(l)) {
					...
					if (timeleft > 0) {
						...
						BlockStorage.getInventory(l).replaceExistingItem(17, item);
						...
						BlockStorage.getInventory(l).replaceExistingItem(17, new CustomItem(new MaterialData(Material.STAINED_GLASS_PANE, (byte) 15), " "));
